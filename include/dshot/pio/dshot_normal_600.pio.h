...
#define dshot_normal_600_wrap_target 0
#define dshot_normal_600_wrap 19

#define dshot_normal_600_BIT_PERIOD 40

static const uint16_t dshot_normal_600_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static const struct pio_program dshot_normal_600_program = {
    .instructions = dshot_normal_600_program_instructions,
    .length = 20,
    .origin = -1,
};

static inline pio_sm_config dshot_normal_600_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + dshot_normal_600_wrap_target, offset + dshot_normal_600_wrap);
    return c;
}
